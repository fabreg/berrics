 ...
 */
	Configure::write('Security.salt', $_SERVER['BERRICS_SALT']);

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', $_SERVER['BERRICS_CIPHER']);
 ...
 */
	...
	Cache::config('stats', array(
 		'engine' => 'File', //[required]
 		'duration'=>'+5 hours', //[optional]
 		'probability'=> 1000, //[optional]
  		'path' => CACHE."/stats", //[optional] use system tmp directory - remember to use absolute path
  		'prefix' => 'cake_stats_', //[optional]  prefix every cache file with this string
  		'lock' => false, //[optional]  use file locking
  		'serialize' => true, //[optional]
 	));
