...
<div class='featured-match'>
	<div class='player1'>
		...
		<div class='flag'>
			<img src='/img/flags/<?php echo strtolower($player1['country']); ?>.png' />
		</div>
