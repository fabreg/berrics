		...
		<td>
			...
			<?php else: ?>
				<?php 
					...
					$lnk = "http://img01.theberrics.com/berrics-icons/".$dailyopSection['DailyopSection']['icon_light_file'];
		...
		<td>
			...
			<?php else: ?>
				<?php 
					...
					$lnk = "http://img01.theberrics.com/berrics-icons/".$dailyopSection['DailyopSection']['icon_dark_file'];
		...
		<td>
			...
			<?php else: ?>
				<?php 
					...
					$lnk = "http://img01.theberrics.com/berrics-icons/".$dailyopSection['DailyopSection']['icon_color_file'];
