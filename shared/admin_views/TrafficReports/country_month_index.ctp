						...
						<td>
							<?php 
								...
								if(is_null($row['DimLocation']['country_code'])) {
									...
									$params = array("controller"=>"traffic_reports","action"=>"country_month_overview","report_month"=>$this->request->data['Filters']['report_month']['month'],"report_year"=>$this->request->data['Filters']['report_year']['year']);
