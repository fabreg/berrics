...
$this->set("title_for_layout","Video: ".$media_file['MediaFile']['name']." | [".$this->request->params['named']['date_start']."] - [".$this->request->params['named']['date_end']."]");
...
<div class='index form'>
	...
	<div style='float:left; width:70%;' id='report-content'>
		...
		Date Start: <?php echo $this->request->params['named']['date_start']; ?> <br /> 
		Date End: <?php echo $this->request->params['named']['date_end']; ?><br />
