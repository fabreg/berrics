...
function openDetails(id,ele) {
	...
	var $newDiv = $("<tr ><td colspan='13' inv='"+id+"' style='padding:0px;' align='right'>Loading</td></tr>");
	...
	<table cellspacing='0' style='font-size:14px;'>
		...
		<tr>
			...
			<td align='center' nowrap width='1%'>
				...
				?>
				<a href='/canteen_products/toggle_active/<?php echo $p['id']; ?>/callback:<?php echo base64_encode($this->request->here); ?>'><?php echo $txt; ?></a>
			</td>
			<td align='center' nowrap width='1%'>
				<?php 
				...
				?>
				<a href='/canteen_products/toggle_featured/<?php echo $p['id']; ?>/callback:<?php echo base64_encode($this->request->here); ?>'><?php echo $txt; ?></a>
			</td>
			<td align='center' nowrap width='1%'>
				<?php 
			...
			<td class='actions' nowrap>
				...
				<a href='/canteen_products/ljg_products/<?php echo $p['id']; ?>/1/callback:<?php echo base64_encode($this->request->here); ?>'>Attach & Create LGJ Inventory</a>
				<?php endif; ?>
			</td>
		</tr>
		<?php 
