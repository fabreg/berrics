...
<div class='form index'>
	...
	<fieldset>
		...
		<div>
			Media File ID: <?php echo $this->request->data['MediaFile']['id']; ?>
		</div>
		<div>
			...
			<p><a href='/media_files/inspect/<?php echo $this->request->data['MediaFile']['id']; ?>' style='color:black;'>Media Entry</a></p>
		</div>
