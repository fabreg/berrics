...
<?php echo $this->Form->create('CanteenOrderNote');?>
	<fieldset>
		<legend><?php echo __('Edit Canteen Order Note'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Admin->link(__('Delete'), array('action' => 'delete', $this->Form->value('CanteenOrderNote.id')), null, sprintf(__('Are you sure you want to delete # %s?'), $this->Form->value('CanteenOrderNote.id'))); ?></li>
