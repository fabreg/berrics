...
<div class='index'>
	...
	<fieldset>
		...
		<?php 
			...
			echo $this->Form->create("YounitedNationsPosse",array("url"=>"/younited_nations_events/search_entries/".$this->request->params['pass'][0]));
 ...
 |
	...
	<table cellspacing='0'>
		...
		<tr>
			...
			<td class='actions'>
				<a href='/younited_nations_events/view_entry/<?php echo $e['YounitedNationsEventEntry']['id']; ?>/callback:<?php echo base64_encode($this->request->here); ?>'>View</a>
			</td>
		</tr>
		<?php endforeach; ?>
	</table>
