<div class='index'>
	...
	<div>
		<fieldset>
			...
			<ul class='actions'>
			<li>
				<a href='/mediahunt_tasks/add/mediahunt_event_id:<?php echo $mediahuntEvent['MediahuntEvent']['id']; ?>/callback:<?php echo base64_encode($this->request->here); ?>'>Add New Task</a>
			</li>
			<li>
	...
	<div>
					...
					<tr>
						...
						<td class='actions'>
							<?php 
								...
								echo $this->Admin->link("Edit",array("controller"=>"mediahunt_tasks","action"=>"edit",$task['MediahuntTask']['id'],"callback"=>base64_encode($this->request->here))); 
								
								echo $this->Admin->link("View Entries",array(
		...
		<div style='float:left; width:49%;'>	
			...
			<table cellspacing='0'>
				...
				<tr>
					<td>
						<a href='http://img01.theberrics.com/mediahunt-media/<?php echo $m['file_name']; ?>' target='_blank'>
							<img src='http://img01.theberrics.com/i.php?src=/mediahunt-media/<?php echo $m['file_name']; ?>&h=75&w=75' border='0'/>
						</a>
					</td>
					<td>
					...
					<td class='actions'>
						<?php echo $this->Admin->link("Approve",array("controller"=>"mediahunt_media_items","action"=>"approve",$m['id'],"callback"=>base64_encode($this->request->here))); ?>
						<?php echo $this->Admin->link("Shit Can",array("controller"=>"mediahunt_media_items","action"=>"delete",$m['id'],"callback"=>base64_encode($this->request->here))); ?>
					</td>
				</tr>
				<?php endforeach; ?>
			</table>
