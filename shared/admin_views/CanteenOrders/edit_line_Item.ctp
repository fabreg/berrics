...
<div class='index form'>
	...
	<fieldset>
		...
		<div class='actions'>
			<a href='/canteen_orders/edit/<?php echo $this->request->data['CanteenOrderItem']['canteen_order_id']; ?>'>Go Back to Order</a>
		</div>
	</fieldset>
	<fieldset>
	...
	<fieldset>
		...
		<table cellspacing='0'>
			<?php foreach($this->request->data['ChildCanteenOrderItem'] as $k=>$c): ?>
			<tr>
				<th></th>
				<th>Name Label</th>
				<th>Sub Label</th>
