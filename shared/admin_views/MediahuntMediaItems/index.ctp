<div class="mediahuntMediaItems index">
	<h2><?php echo __('Mediahunt Media Items');?></h2>
 ...
 |
	...
	<tr<?php echo $class;?>>
		...
		<td>
			<a href='http://img01.theberrics.com/mediahunt-media/<?php echo $mi['file_name'];  ?>' target='_blank'>
				<img border='0' src='http://img01.theberrics.com/i.php?src=/mediahunt-media/<?php Echo $mi['file_name']; ?>&w=100'  />
			</a>
		</td>
		<td>
			<?php 
				...
				echo $this->Form->input("callback",array("type"=>"hidden","value"=>base64_encode($this->request->here)));
		...
		<td class="actions">
			<?php echo $this->Admin->link("Approve",array("action"=>"approve",$mi['id'],"callback"=>base64_encode($this->request->here))); ?>
			<?php echo $this->Admin->link("Shit Can",array("action"=>"delete",$mi['id'],"callback"=>base64_encode($this->request->here))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
