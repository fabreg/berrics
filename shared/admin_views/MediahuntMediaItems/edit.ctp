...
<?php echo $this->Form->create('MediahuntMediaItem');?>
	<fieldset>
		<legend><?php echo __('Edit Mediahunt Media Item'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Admin->link(__('Delete'), array('action' => 'delete', $this->Form->value('MediahuntMediaItem.id')), null, sprintf(__('Are you sure you want to delete # %s?'), $this->Form->value('MediahuntMediaItem.id'))); ?></li>
