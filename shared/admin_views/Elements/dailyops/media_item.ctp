	...
	<div class='right'>
		<table cellspacing='0' >
			...
			<tr>
				<td>Remove File:</td>
				<td>
					<?php echo $this->Admin->link("Click Here",array("controller"=>"dailyops","action"=>"remove_media_item",$i['id']),array("rel"=>"remove-link")); ?>
				</td>
			</tr>
			...
			<tr>
				<td>Preview Video</td>
				<td>
					<?php echo $this->Admin->link("Click Here",array("controller"=>"media_files","action"=>"preview_video",$m['id']),array("target"=>"_blank")); ?>
				</td>
			</tr>
				<?php  endif; ?>
			<tr>
				...
				<td>
					<?php echo $this->Admin->link("Click Here",array("controller"=>"media_files","action"=>"update_video_still",$m['id']),array("target"=>"_blank")); ?>
				</td>
			</tr>
			<tr>
