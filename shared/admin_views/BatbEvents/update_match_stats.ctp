...
<?php echo $this->Admin->link("<< Go Back To The Brackets",array("action"=>"view",$match['BatbMatch']['batb_event_id'])); ?>
</div>
<div class='actions' style='font-size:130%; font-weight:bold;  padding:5px;'>
<?php echo $this->Admin->link("Watch The Battle",$match['BatbMatch']['legacy_video_link'],array("target"=>"_blank")); ?>
</div>
<?php 

	echo $this->Form->create("BatbMatch",array("url"=>$this->request->here));
?>
<fieldset>
