<div class='index form'>
	...
	<?php echo $this->Form->create("CanteenShippingRecord",array("url"=>$this->request->here)); ?>
	<fieldset>
		<legend>Add New Shipping Record</legend>
		<?php 
			
			if(isset($this->request->data['CanteenShippingRecord']['canteen_order_id'])) echo $this->Form->input("canteen_order_id",array("type"=>"text"));
