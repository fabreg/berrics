...
<div style='width:95%; margin:auto;'>
	<fieldset>
		...
		<div class='index'>
			<?php if(count($this->request->data['BerricsRecordsItem'])<=0): ?>
			...
			<?php else: ?>
				<table cellspacing='0'>
					...
					<?php foreach($this->request->data['BerricsRecordsItem'] as $item):?>
					<tr>
						...
						<td align='center'>
							<?php 
								...
								echo $this->Form->input("berrics_record_id",array("value"=>$this->request->data['BerricsRecord']['id'],"type"=>"hidden"));
...
<div class='form'>
	<fieldset>
		...
		<?php 
			...
			echo $this->Form->input("BerricsRecordsItem.berrics_record_id",array("value"=>$this->request->data['BerricsRecord']['id'],"type"=>"hidden"));
