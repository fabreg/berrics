...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Admin->link(__('Edit User', true), array('action' => 'edit', $user['User']['id'])); ?> </li>
		<li><?php echo $this->Admin->link(__('Delete User', true), array('action' => 'delete', $user['User']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $user['User']['id'])); ?> </li>
		<li><?php echo $this->Admin->link(__('List Users', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Admin->link(__('New User', true), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $this->Admin->link(__('View', true), array('controller' => 'banners', 'action' => 'view', $banner['id'])); ?>
				<?php echo $this->Admin->link(__('Edit', true), array('controller' => 'banners', 'action' => 'edit', $banner['id'])); ?>
				<?php echo $this->Admin->link(__('Delete', true), array('controller' => 'banners', 'action' => 'delete', $banner['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $banner['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $this->Admin->link(__('View', true), array('controller' => 'dailyops', 'action' => 'view', $dailyop['id'])); ?>
				<?php echo $this->Admin->link(__('Edit', true), array('controller' => 'dailyops', 'action' => 'edit', $dailyop['id'])); ?>
				<?php echo $this->Admin->link(__('Delete', true), array('controller' => 'dailyops', 'action' => 'delete', $dailyop['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $dailyop['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $this->Admin->link(__('View', true), array('controller' => 'media_files', 'action' => 'view', $mediaFile['id'])); ?>
				<?php echo $this->Admin->link(__('Edit', true), array('controller' => 'media_files', 'action' => 'edit', $mediaFile['id'])); ?>
				<?php echo $this->Admin->link(__('Delete', true), array('controller' => 'media_files', 'action' => 'delete', $mediaFile['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $mediaFile['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $this->Admin->link(__('View', true), array('controller' => 'user_permissions', 'action' => 'view', $userPermission['id'])); ?>
				<?php echo $this->Admin->link(__('Edit', true), array('controller' => 'user_permissions', 'action' => 'edit', $userPermission['id'])); ?>
				<?php echo $this->Admin->link(__('Delete', true), array('controller' => 'user_permissions', 'action' => 'delete', $userPermission['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $userPermission['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
