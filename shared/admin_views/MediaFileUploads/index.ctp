...
<div class='index'>
	...
	<table cellspacing='0' style='font-size:12px;' >
		...
		<tr>
			...
			<td class='actions'>
				<a href='/media_file_uploads/edit/<?php echo $f['MediaFileUpload']['id']; ?>/<?php echo base64_encode($this->request->here); ?>'>Edit</a>
				<a href="" class="btn btn-small btn-danger">
					<i class="icon icon-remove icon-white"></i> Reject
				</a>
			</td>
		</tr>
		<?php endforeach; ?>
