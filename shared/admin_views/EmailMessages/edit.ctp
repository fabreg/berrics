...
<?php echo $this->Form->create('EmailMessage');?>
	<fieldset>
 		<legend><?php echo __('Edit Email Message'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Admin->link(__('Delete'), array('action' => 'delete', $this->Form->value('EmailMessage.id')), null, sprintf(__('Are you sure you want to delete # %s?'), $this->Form->value('EmailMessage.id'))); ?></li>
		<li><?php echo $this->Admin->link(__('List Email Messages'), array('action' => 'index'));?></li>
	</ul>
</div>