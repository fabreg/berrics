...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Admin->link(__('Delete'), array('action' => 'delete', $this->Form->value('UserPermission.id')), null, sprintf(__('Are you sure you want to delete # %s?'), $this->Form->value('UserPermission.id'))); ?></li>
