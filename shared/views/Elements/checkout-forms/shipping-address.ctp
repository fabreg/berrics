...
<div>
	<?php 
		...
		echo $this->Form->input("ShippingAddress.address_type",array("type"=>"hidden","value"=>"shipping"));
		echo $this->Form->input("ShippingAddress.email",array("label"=>$l['email']));
		echo $this->Form->input("ShippingAddress.first_name",array("label"=>$l['fname']));
		echo $this->Form->input("ShippingAddress.last_name",array("label"=>$l['lname']));
		echo $this->Form->input("ShippingAddress.street",array("label"=>$l['streetaddress']));
		echo $this->Form->input("ShippingAddress.apt",array("label"=>$l['apt']));
		echo $this->Form->input("ShippingAddress.country_code",array("label"=>$l['country'],"options"=>Arr::countries()));
		echo $this->Form->input("ShippingAddress.state",array("label"=>$l['state'],"options"=>Arr::states(),"div"=>array("id"=>"form-shipping-state-select-div")));
		...
		echo $this->Form->input("ShippingAddress.city",array("label"=>$l['city']));
		echo $this->Form->input("ShippingAddress.postal_code",array("label"=>$l['zip']));
		echo $this->Form->input("ShippingAddress.phone",array("label"=>$l['phonenum']))
	?>
</div>