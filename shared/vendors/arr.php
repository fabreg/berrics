...
class Arr {
	...
	public static function adLabelUrls() {
		...
		return array(
			"preroll"=>"http://ad.doubleclick.net/N5885/adx/#LABEL#;sz=8x8;#TAGS#ord=".md5(microtime().mt_rand(99,9999))."?",
			"postroll"=>"http://ad.doubleclick.net/N5885/adx/#LABEL#;sz=8x8;#TAGS#ord=".md5(microtime().mt_rand(99,9999))."?"
		);
