		...
		<div class='vote-section'>
			<div class='entries'>
				...
				<?php foreach($entries as $v): ?>
					<div class='entry-div' style='background-image:url(http://img01.theberrics.com/images/<?php echo $v['DailyopMediaItem'][1]['MediaFile']['file']; ?>);' dailyop_id='<?php echo $v['Dailyop']['id']; ?>'>
				...
				<div class='voting-form'>
					...
					<div class='inner'>
						...
						<?php for($i=0;$i<5;$i++): ?>
							...
							?>
							<div class='vote-result-div' style='background-image:url(http://img01.theberrics.com/images/<?php echo $e['DailyopMediaItem'][2]['MediaFile']['file']; ?>);'>
