	...
	<div class='leaders'>
		<table cellspacing='0'>
			...
			<tr>
				...
				<td><a href='/battle-at-the-berrics-6/scorecard/<?php echo $v['User']['id']; ?>'><?php $name = strtoupper($v['User']['first_name'])." ".strtoupper($v['User']['last_name']); echo $this->Text->truncate($name,35); ?></a></td>
