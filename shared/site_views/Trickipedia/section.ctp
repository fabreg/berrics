		...
		?>
			<div class="trick-div clearfix">
				<div class="img">
					...
					<img src='http://img01.theberrics.com/i.php?src=/loading-imgs/loading-700.jpg&amp;h=60&amp;w=60&amp;zc=1' data-original="http://img01.theberrics.com/i.php?src=/images/<?php echo $img['file']; ?>&amp;w=60&amp;h=60&amp;zc=1" alt="" class='lazy' />
					</a>
				</div>
				<div class="info">
					<div class="trick">
