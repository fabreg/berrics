...
<div id='news-article'>
	<div>
		...
		<div>
			<a href='/news/<?php echo date("Y",strtotime($this->request->params['date_in'])); ?>/<?php echo date("m",strtotime($this->request->params['date_in'])); ?>/<?php echo date("d",strtotime($this->request->params['date_in'])); ?>'>
