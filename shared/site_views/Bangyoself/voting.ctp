	...
	<div class='votes'>
		...
		<div class='finalist'>
			...
			<a href='/<?php echo $post['Post']['DailyopSection']['uri']; ?>/<?php echo $post['Post']['Dailyop']['uri']; ?>'>
				...
				?>
				<img border='0' alt='' src='http://img01.theberrics.com/images/<?php echo $img; ?>' />
			</a>
		</div>
		<?php  
...
<?php endif; ?>
<?php
if(preg_match('/^(\/dailyops)/',$_SERVER['REQUEST_URI']) || (isset($this->request->params['year']) && isset($this->request->params['month']) && isset($this->request->params['day']))):
?>
