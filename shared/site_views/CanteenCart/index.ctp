...
?>
<?php echo $this->Form->create("CanteenOrder",array("url"=>$this->request->here,"id"=>"checkout-form")); ?>
<div id='canteen-cart'>
	<div class='header'>
			...
			<div class='checkout'>
				<div class='totals'>
					<dl class='totals-list'>
						...
						<div style='font-size:12px; font-style:italic; text-align:center;'>Amounts shown are in <?php echo $this->request->data['CanteenOrder']['currency_id']; ?></div>
						<?php endif; ?>
						<?php if($this->request->data['CanteenOrder']['discount_total']<0): ?>
						<dt class='discount-total-label'>Discount...</dt>
						<dd id='discount-total-dd'><?php echo number_format($this->request->data['CanteenOrder']['discount_total'],2); ?></dd>
						<?php endif; ?>
						<dt>Sub-Total..</dt>
