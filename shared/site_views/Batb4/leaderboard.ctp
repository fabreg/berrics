...
<div id='leaderboard-header'>
	<div class='tabs'>
		<ul>
			<li class='selected'><a href='/<?php echo $this->request->params['section']; ?>/leaderboard/overall'>Overall Scores</a></li>
			<li><a href='/<?php echo $this->request->params['section']; ?>/score/<?php echo $this->Session->read("Auth.User.id"); ?>'>My Profile</a></li>
		</ul>
	</div>
</div>
...
<table cellspacing='0' width='100%' class='lb-table'>
	...
	<?php 
		...
		if($this->request->params['pass'][0] != 'overall') {
