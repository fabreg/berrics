...
function initProductThumbs() {
	...
	$("#product-standard-view .thumbs .img-thumb").click(function() { 
		...
		$(".product-img .main-image img").attr("src","http://img01.theberrics.com/i.php?w=485&h=485&zc=1&src=/product-img/"+src);
					...
					<div class='product-info'>
						<?php 
								...
								if($this->Session->check("CanteenAdminAddItem.canteen_order_item")) {
									...
									$uri = "http://dev.cp.theberrics.com/canteen_orders/add_item";
						...
						<div class='style-code-options'>
							...
							<div class='options-div'>
								...
								<div class='option' uri='<?php echo $s['CanteenProduct']['uri']; ?>'>
									...
									<img src='http://img01.theberrics.com/i.php?src=/product-img/<?php echo $s['CanteenProduct']['style_code_image']; ?>&h=35&w=35&zc=1' border='0' alt='' style='border:1px solid #333;' />
								</div>
								<?php endforeach; ?>
								<div style='clear:both;'></div>
							</div>
						...
						<div class='zuckerberg-shoutout'>
							<div style='float:left; margin-right:4px;'>
								<a href="http://twitter.com/share" class="twitter-share-button" data-url="<?php echo "http://".$_SERVER['SERVER_NAME'].$this->here; ?>" data-text='<?php echo addslashes($product['CanteenProduct']['name']." ".$product['CanteenProduct']['sub_title']); ?>' data-count="none" data-via="berrics">Tweet</a>
							</div> 
...
<a href='http://cp.theberrics.com/canteen_products/edit/<?php Echo $product['CanteenProduct']['id']; ?>' target='_blank'>Edit</a>
<?php endif; ?>
<pre>
<?php 
