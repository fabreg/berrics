...
class Batb4Controller extends DailyopsController {
		...
		if($this->request->data) {
			...
			for($i=1;$i<=2;$i++) {
				...
				$data = array(
					...
					"match_winner_user_id"=>$this->request->data['BatbVote']['match_winner_user_id-'.$i],
					"rps_winner_user_id"=>$this->request->data['BatbVote']['rps_winner_user_id-'.$i],
					"winner_letters"=>$this->request->data['BatbVote']['winner_letters-'.$i],
					"batb_match_id"=>$this->request->data['BatbVote']['batb_match_id-'.$i],
					"user_id"=>$this->Auth->user("id")
	...
	public function confirm_vote() {
		...
		if(count($this->request->data)) {
			...
			$batb_event_id = $this->request->data['batb_event_id'];
			...
			foreach($ids as $id) {
				...
				$this->BatbVote->save(array(
					...
					"match_winner_user_id"=>$this->request->data[$id]['match_winner_user_id'],
					"rps_winner_user_id"=>$this->request->data[$id]['rps_winner_user_id'],
					"winners_letters"=>$this->request->data[$id]['winners_letters'],
