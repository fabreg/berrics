...
class DailyopsController extends LocalAppController {
	...
	public function index() {
		...
		if($this->theme == "battle-at-the-berrics-6" && in_array(strtoupper(date("D")),array("SUN","MON")) && $home_mode) {
		...
		if(in_array(date("Y-m-d"),Array("2013-02-22","2013-02-23"))) {

			$this->theme = "distreeto-ground-control-united";
