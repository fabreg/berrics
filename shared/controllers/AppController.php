...
class AppController extends Controller {
	...
	public $components = array("RequestHandler","Session","Auth","Paginator");
	...
	public function beforeFilter(/*POLYMORPHIC*/) {
		...
		if(!in_array(strtolower($this->request->params['controller']),array("login","img","media","css")) && (!$this->request->is('ajax'))) {
