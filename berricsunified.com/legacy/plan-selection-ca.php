...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<!-- NAVIGATION -->
		...
		<div id="leftside">
		<a href="UNIFIED_CHECKLIST.pdf"><img src="img/lefcol_reqs.jpg" width="140" border="0" alt="BERRICS UNIFIED REQUIRED INFO" /></a>
		<a href="contact.html"><img src="img/lefcol_contact.jpg" width="140" border="0" alt="BERRICS UNIFIED CONTACT" /></a>
		</div>
		...
		<div id="formmid">
		<div id="formWrap">
			<img src="img/membership_plan.gif">
			<div class="planBox">
					<div class="rateboxa">
						<div class="rateboxhead">BASIC</div>
						<div class="rateboxcontenta">
							<!-- FORM - BASIC -->
							<form action="confirm-ca.php" method="POST" name="canbas">
								<div style="height:100px;">
									<img src="img/CHART3can01.png" width="150" height="100" border="0" alt="" />
								</div>
								<div class="planselector">
									<input type="hidden" name="plan" value="1" />
									<input type="image" src="img/select-plan.gif" value"">
								</div>
							</form>
						</div>
					</div>
					<div class="rateboxb">
						<div class="rateboxhead">CITY</div>
						<div class="rateboxcontent">
							<!-- FORM - CITY -->
							<form action="confirm-ca.php" method="POST" name="cancit">
								<div style="height:100px;">
									<img src="img/CHART3can02.png" width="150" height="100" border="0" alt="" />
								</div>
								<div class="planselector">
					...
					<div class="rateboxc">
						<div class="rateboxhead">PROVINCE</div>
						<div class="rateboxcontent">
							<!-- FORM - PROVINCE -->
							<form action="confirm-ca.php" method="POST" name="canpro">
								<div style="height:100px;">
									<img src="img/CHART3can03.png" width="150" height="100" border="0" alt="" />
								</div>
								<div class="planselector">
					...
					<div class="rateboxd">
						<div class="rateboxhead">REGION</div>
						<div class="rateboxcontent">
							<!-- FORM - REGION -->
							<form action="confirm-ca.php" method="POST" name="pbas">
								<div style="height:100px;">
									<img src="img/CHART3can04.png" width="150" height="100" border="0" alt="" />
								</div>
								<div class="planselector">
					...
					<div class="rateboxe">
						<div class="rateboxhead">2-REGION</div>
						<div class="rateboxcontent">
							<!-- FORM - 2 REGION -->
							<form action="confirm-ca.php" method="POST" name="pbas">
								<div style="height:100px;">
									<img src="img/CHART3can05.png" width="150" height="100" border="0" alt="" />
								</div>
								<div class="planselector">
					...
					<div class="rateboxf">
						<div class="rateboxhead">NATIONAL</div>
						<div class="rateboxcontent">
							<!-- FORM - NATIONAL -->
							<form action="confirm-ca.php" method="POST" name="pbas">
								<div style="height:100px;">
									<img src="img/CHART3can06.png" width="150" height="100" border="0" alt="" />
								</div>
								<div class="planselector">
				...
				<div style="position:relative;top:160px;"><img src="img/region-map-ca.png"></div>
			</div>
