...
<table cellspacing='0'>
	<tr class='title-row'>
		<td class='left'><img src='/theme/battle-at-the-berrics-4/img/flags_sm/<?php echo strtolower($p1['country']); ?>.png' /> <?php echo $p1['first_name']; ?> <?php echo $p1['last_name']?></td>
		<td class='center'>VS.</td>
		<td class='right'><img src='/theme/battle-at-the-berrics-4/img/flags_sm/<?php echo strtolower($p2['country']); ?>.png' /> <?php echo $p2['first_name']; ?> <?php echo $p2['last_name']; ?></td>
