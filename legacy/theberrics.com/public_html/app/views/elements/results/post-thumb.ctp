...
if(!empty($dop['DailyopSection']['icon_light_file'])) {
	...
	//$style='background-image:url(http://img.theberrics.com/i.php?src=/berrics-icons/'.$dop['DailyopSection']['icon_light_file'].'&w=24&h=24)';
...
?>
<div class='post-thumb-small post-thumb' showBubble='<?php echo $showBubble; ?>'  name='<?php echo htmlentities($d['name'],ENT_QUOTES); ?>' sub_title='<?php echo htmlentities($d['sub_title'],ENT_QUOTES); ?>' media_type='<?php echo $d['media_type']; ?>'>
