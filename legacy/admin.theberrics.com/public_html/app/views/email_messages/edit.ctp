...
<?php echo $this->Form->create('EmailMessage');?>
	<fieldset>
 		<legend><?php __('Edit Email Message'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('EmailMessage.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('EmailMessage.id'))); ?></li>
