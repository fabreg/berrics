<div class='index'>
	...
	<table cellspacing='0'>
		...
		<tr>
			...
			<td class='actions'>
				<?php echo $this->Html->link("View File",array("action"=>"view_lajolla_tracking_file",$f['id']),array("target"=>"_blank")); ?>
				<?php if($f['processed']==0) echo $this->Html->link("Process File",array("action"=>"process_tracking_file",$f['id'])); ?>
			</td>
		</tr>
		<?php endforeach; ?>
	</table>
