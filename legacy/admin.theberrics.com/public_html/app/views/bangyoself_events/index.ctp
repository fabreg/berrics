<div class="bangyoselfEvents index">
	<h2><?php __('Bangyoself Events');?></h2>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View Entries', true), array('action' => 'view', $bangyoselfEvent['BangyoselfEvent']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $bangyoselfEvent['BangyoselfEvent']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $bangyoselfEvent['BangyoselfEvent']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $bangyoselfEvent['BangyoselfEvent']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('New Bangyoself Event', true), array('action' => 'add')); ?></li>
