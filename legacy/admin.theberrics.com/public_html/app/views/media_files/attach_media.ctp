...
$(document).ready(function() { 
	...
	browseFiles('<?php echo $this->Html->url(array("controller"=>"media_files","action"=>"index")); ?>',"#media-browser");
...
<div class='form'>
	...
	<fieldset>
		...
		<?php echo $this->Form->create("AttachMedia",array("url"=>$this->here,"id"=>"AttachForm")); ?>
		...
		<?php 
			...
			echo $this->Form->hidden("model",array("value"=>$this->data['model']));
			echo $this->Form->hidden("key",array("value"=>$this->data['key']));
			echo $this->Form->hidden("val",array("value"=>$this->data['val']));
			echo $this->Form->hidden("post_back",array("value"=>$this->data['post_back']));
