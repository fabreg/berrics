<div class='index'>
	...
	?>
		<tr>
			...
			<td class='actions'>
				<?php echo $this->Html->link("View Brackets",array("action"=>"view",$event['BatbEvent']['id'])); ?>
				<?php echo $this->Html->link("Update User Rankings",array("controller"=>"batb_events","action"=>"update_user_rankings",$event['BatbEvent']['id'])); ?>
			</td>
