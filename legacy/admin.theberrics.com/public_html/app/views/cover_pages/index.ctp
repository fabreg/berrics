...
if(isset($this->params['named']['CoverPage.aberrica_category_id'])) {
	...
	$cat_id = $this->params['named']['CoverPage.aberrica_category_id'];
...
<h2>Cover Pages</h2>
 ...
 |
		...
		<div class='actions'>
		<ul>
			<?php echo $this->Html->link("Add New Cover Page",array("action"=>"add",$cat_id)); ?>
		</ul>
	</div>
	<table cellspacing='0'>
		<tr>
		...
		<tr>
			...
			<td class='actions'>
				<?php 
					...
					echo $this->Html->link("Edit",array("action"=>"edit",$v['CoverPage']['id']));
