		...
		<div class='right-col'>
			<div id='lrg-300-250'>
				<script type="text/javascript">
				  ...
				  document.write('<script type="text/javascript" src="http://ad.doubleclick.net/N5885/adj/batb5;sz=300x250;ord=' + ord + '?"><\/script>');
				</script>
				<noscript>
				<a href="http://ad.doubleclick.net/N5885/jump/batb5;sz=300x250;ord=[timestamp]?">
					<img src="http://ad.doubleclick.net/N5885/ad/batb5;sz=300x250;ord=[timestamp]?" width="300" height="250" />
				</a>
				</noscript>
			</div>
		</div>
