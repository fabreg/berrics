...
<div class='emotw-div'>
	...
	?>
		<span class='paging-link prev-link' page='<?php echo ($this->params['paging']['DailyopTextItem']['prevPage']-$this->params['paging']['DailyopTextItem']['defaults']['step']) ?>' dailyop_id='<?php echo $item[0]['DailyopTextItem']['dailyop_id']; ?>'>PREVIOUS</span>
	<?php 
		endif;
	?>
	...
	?>
		<span class='paging-link next-link' page='<?php echo ($this->params['paging']['DailyopTextItem']['nextPage']+$this->params['paging']['DailyopTextItem']['defaults']['step']) ?>' dailyop_id='<?php echo $item[0]['DailyopTextItem']['dailyop_id']; ?>'>NEXT</span>
	<?php 
		endif;
	?>
	<div class='paging-info'><?php echo $this->params['paging']['DailyopTextItem']['page']; ?> of <?php echo $this->params['paging']['DailyopTextItem']['pageCount']; ?></div>
	</div>
</div>