...
<?php 
	...
	if($k == 0) {
		...
		echo "<div style='text-align:center; padding-bottom:3px;'><a href='/battle-at-the-berrics-5'><img border='0' src='/theme/battle-at-the-berrics-5/img/week6-winner.jpg' /></a></div>";
