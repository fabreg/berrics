...
<?php 
	...
	if($k == 0) {
		...
		echo "<div style='text-align:center; padding:0px; padding-bottom:5px;'><a href='/text-yoself-beefo-yo-wreck-yoself/geoff-rowley.html' title='Skullcandy Presents: 31 Days Of Theotis'><img style='display:block; padding:0px; margin:auto;' src='/theme/31-days-of-theotis/img/31DOT_toppost-7.jpg' border='0' alt='Skullcandy Presents: 31 Days Of Theotis' /></a></div>";
