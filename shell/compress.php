...
foreach($files as $file) {
	...
	switch(strtolower(pathinfo($f[1],PATHINFO_EXTENSION))) {
		...
		case "css":
			echo $newFileName,"\n";
			echo `java -jar $cdir/yuicompressor-2.4.8pre.jar --type css -o $newFileName $f[1];`;
		break;
		case "js":
			echo $newFileName,"\n";
			echo `java -jar $cdir/yuicompressor-2.4.8pre.jar --charset utf-8 --type js --nomunge --preserve-semi -o $newFileName $f[1];`;
		break;
