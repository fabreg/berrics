...
class DfpUser extends AdsUser {
  private static $LIB_VERSION = '2.6.0';
  ...
  /**
   * Gets the CompanyService SOAP client.
   ...
   * @return CompanySevice the instantiated company service
   */
  public function GetCompanyService($version = NULL,
      $server = NULL, SoapClientFactory $serviceFactory = NULL) {
    return $this->GetService('CompanyService', $version, $server,
        $serviceFactory);
  }

  /**
   * Gets the CreativeService SOAP client.
   * @param string $version the version of the service to get. If
   *     <var>NULL</var>, then the default version will be used
   * @param string $server the server to make the request to. If
   *     <var>NULL</var>, then the default server will be used
   * @param SoapClientFactory $serviceFactory the factory to create the client.
   *     If <var>NULL</var>, then the built-in SOAP client factory will be used
   * @return CreativeSevice the instantiated creative service
   */
  public function GetCreativeService($version = NULL,
      $server = NULL, SoapClientFactory $serviceFactory = NULL) {
    return $this->GetService('CreativeService', $version, $server,
        $serviceFactory);
  }

  /**
   * Gets the CustomTargetingService SOAP client.
   * @param string $version the version of the service to get. If
   *     <var>NULL</var>, then the default version will be used
   * @param string $server the server to make the request to. If
   *     <var>NULL</var>, then the default server will be used
   * @param SoapClientFactory $serviceFactory the factory to create the client.
   *     If <var>NULL</var>, then the built-in SOAP client factory will be used
   * @return CustomTargetingService the instantiated custom targeting service
   */
  public function GetCustomTargetingService($version = NULL,
      $server = NULL, SoapClientFactory $serviceFactory = NULL) {
    return $this->GetService('CustomTargetingService', $version, $server,
        $serviceFactory);
  }

  /**
   * Gets the ForecastService SOAP client.
   * @param string $version the version of the service to get. If
   *     <var>NULL</var>, then the default version will be used
   * @param string $server the server to make the request to. If
   *     <var>NULL</var>, then the default server will be used
   * @param SoapClientFactory $serviceFactory the factory to create the client.
   *     If <var>NULL</var>, then the built-in SOAP client factory will be used
   * @return ForcastService the instantiated forecast service
   */
  public function GetForecastService($version = NULL,
      $server = NULL, SoapClientFactory $serviceFactory = NULL) {
    return $this->GetService('ForecastService', $version, $server,
        $serviceFactory);
  }

  /**
   * Gets the InventoryService SOAP client.
   * @param string $version the version of the service to get. If
   *     <var>NULL</var>, then the default version will be used
   * @param string $server the server to make the request to. If
   *     <var>NULL</var>, then the default server will be used
   * @param SoapClientFactory $serviceFactory the factory to create the client.
   *     If <var>NULL</var>, then the built-in SOAP client factory will be used
   * @return InventorySevice the instantiated inventory service
   */
  public function GetInventoryService($version = NULL,
      $server = NULL, SoapClientFactory $serviceFactory = NULL) {
    return $this->GetService('InventoryService', $version, $server,
        $serviceFactory);
  }

  /**
   * Gets the LineItemCreativeAssociationService SOAP client.
   * @param string $version the version of the service to get. If
   *     <var>NULL</var>, then the default version will be used
   * @param string $server the server to make the request to. If
   *     <var>NULL</var>, then the default server will be used
   * @param SoapClientFactory $serviceFactory the factory to create the client.
   *     If <var>NULL</var>, then the built-in SOAP client factory will be used
   * @return LineItemCreativeAssociationService the instantiated LICA service
   */
  public function GetLineItemCreativeAssociationService(
      $version = NULL, $server = NULL,
      SoapClientFactory $serviceFactory = NULL) {
    return $this->GetService('LineItemCreativeAssociationService', $version,
        $server, $serviceFactory);
  }

  /**
   * Gets the LineItemService SOAP client.
   * @param string $version the version of the service to get. If
   *     <var>NULL</var>, then the default version will be used
   * @param string $server the server to make the request to. If
   *     <var>NULL</var>, then the default server will be used
   * @param SoapClientFactory $serviceFactory the factory to create the client.
   *     If <var>NULL</var>, then the built-in SOAP client factory will be used
   * @return LineItemService the instantiated line item service
   */
  public function GetLineItemService($version = NULL,
      $server = NULL, SoapClientFactory $serviceFactory = NULL) {
    return $this->GetService('LineItemService', $version, $server,
        $serviceFactory);
  }

  /**
   * Gets the NetworkService SOAP client.
   * @param string $version the version of the service to get. If
   *     <var>NULL</var>, then the default version will be used
   * @param string $server the server to make the request to. If
   *     <var>NULL</var>, then the default server will be used
   * @param SoapClientFactory $serviceFactory the factory to create the client.
   *     If <var>NULL</var>, then the built-in SOAP client factory will be used
   * @return NetworkService the instantiated network service
   */
  public function GetNetworkService($version = NULL,
      $server = NULL, SoapClientFactory $serviceFactory = NULL) {
    return $this->GetService('NetworkService', $version, $server,
        $serviceFactory);
  }

  /**
   * Gets the OrderService SOAP client.
   * @param string $version the version of the service to get. If
   *     <var>NULL</var>, then the default version will be used
   * @param string $server the server to make the request to. If
   *     <var>NULL</var>, then the default server will be used
   * @param SoapClientFactory $serviceFactory the factory to create the client.
   *     If <var>NULL</var>, then the built-in SOAP client factory will be used
   * @return OrderService the instantiated order service
   */
  public function GetOrderService($version = NULL,
      $server = NULL, SoapClientFactory $serviceFactory = NULL) {
    return $this->GetService('OrderService', $version, $server,
        $serviceFactory);
  }

  /**
   * Gets the UserService SOAP client.
   * @param string $version the version of the service to get. If
   *     <var>NULL</var>, then the default version will be used
   * @param string $server the server to make the request to. If
   *     <var>NULL</var>, then the default server will be used
   * @param SoapClientFactory $serviceFactory the factory to create the client.
   *     If <var>NULL</var>, then the built-in SOAP client factory will be used
   * @return UserService the instantiated user service
   */
  public function GetUserService($version = NULL,
      $server = NULL, SoapClientFactory $serviceFactory = NULL) {
    return $this->GetService('UserService', $version, $server, $serviceFactory);
  }

  /**
   * Gets the PlacementService SOAP client.
   * @param string $version the version of the service to get. If
   *     <var>NULL</var>, then the default version will be used
   * @param string $server the server to make the request to. If
   *     <var>NULL</var>, then the default server will be used
   * @param SoapClientFactory $serviceFactory the factory to create the client.
   *     If <var>NULL</var>, then the built-in SOAP client factory will be used
   * @return PlacementService the instantiated placement service
   */
  public function GetPlacementService($version = NULL,
      $server = NULL, SoapClientFactory $serviceFactory = NULL) {
    return $this->GetService('PlacementService', $version, $server,
        $serviceFactory);
  }

  /**
   * Gets the PublisherQueryLanguageService SOAP client.
   * @param string $version the version of the service to get. If
   *     <var>NULL</var>, then the default version will be used
   * @param string $server the server to make the request to. If
   *     <var>NULL</var>, then the default server will be used
   * @param SoapClientFactory $serviceFactory the factory to create the client.
   *     If <var>NULL</var>, then the built-in SOAP client factory will be used
   * @return PublisherQueryLanguageService the instantiated publisher query
   *     language service
   */
  public function GetPublisherQueryLanguageService($version = NULL,
      $server = NULL, SoapClientFactory $serviceFactory = NULL) {
    return $this->GetService('PublisherQueryLanguageService', $version, $server,
        $serviceFactory);
  }

  /**
   * Gets the ReportService SOAP client.
   * @param string $version the version of the service to get. If
   *     <var>NULL</var>, then the default version will be used
   * @param string $server the server to make the request to. If
   *     <var>NULL</var>, then the default server will be used
   * @param SoapClientFactory $serviceFactory the factory to create the client.
   *     If <var>NULL</var>, then the built-in SOAP client factory will be used
   * @return ReportService the instantiated report service
   */
  public function GetReportService($version = NULL,
      $server = NULL, SoapClientFactory $serviceFactory = NULL) {
    return $this->GetService('ReportService', $version, $server,
        $serviceFactory);
  }
