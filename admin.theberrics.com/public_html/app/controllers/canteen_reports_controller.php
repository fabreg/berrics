...
class CanteenReportsController extends AdminAppController {
	...
	public function canteen_order_items() {
		...
		if(count($this->data)) {
			...
			if(isset($this->data['CanteenOrderItem']['CanteenCategory']) && !empty($this->data['CanteenOrderItem']['CanteenCategory'])) {
				
				$cond['CanteenProduct.canteen_category_id'] = $this->data['CanteenOrderItem']['CanteenCategory'];
