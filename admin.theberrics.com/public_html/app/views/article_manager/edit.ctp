...
?>
<script>
var article_id = <?php echo $this->data['Article']['id']; ?>;
...
function loadMediaGallery() {
	...
	$("#media-gallery").html("Loading Media Items....").load("<?php echo $this->Html->url(array("action"=>"ajax_load_media_items",$this->data['Article']['id'])); ?>",{},function(d) { 
...
<div class='form' style='width:900px; margin:auto;'>
	<div style=''>
		<?php 
			...
			echo $this->Form->create("Article",array("url"=>$this->here,"id"=>"ArticleDetailsForm"));
		?>
		<fieldset>
			...
			<div class='text'>
				...
				<?php 
					...
					if(count($this->data['MediaFile'])>0) {
			...
			<?php echo $this->Admin->attachMediaLink("Article","article_id",$this->data['Article']['id'],"/article_manager/edit/".$this->data['Article']['id']); ?>
			</div>
			<?php 
		...
		<fieldset>
			...
			<?php 
				...
				echo $this->Form->create("ArticleParagraphs",array("url"=>array("controller"=>"article_manager","action"=>"ajax_update_paragraphs",$this->data['Article']['id']),"id"=>"ArticleParagraphsForm"));
		...
		<fieldset>
			...
			<div class='attach-media-link'>
					<?php echo $this->Admin->attachMediaLink("ArticleMediaItem","article_id",$this->data['Article']['id'],"/article_manager/edit/".$this->data['Article']['id']); ?> 
