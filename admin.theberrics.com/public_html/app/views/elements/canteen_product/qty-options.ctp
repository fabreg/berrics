				...
				<?php foreach($o['CanteenProductInventory'] as $inv): ?>
					<div>
						...
						<strong>WH:</strong> <?php echo $inv['CanteenInventoryRecord']['Warehouse']['name']; ?>
						 <strong>ITEM#:</strong> <?php echo (empty($inv['CanteenInventoryRecord']['foreign_key'])) ? "<span style='color:red; font-size:20px;'>NO ITEM NUMBER!!</span>":$inv['CanteenInventoryRecord']['foreign_key']; ?>  
