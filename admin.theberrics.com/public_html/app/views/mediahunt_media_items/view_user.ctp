...
<div class='index'>
	...
	<div>
		...
		<a href='/mediahunt_media_items/mark_winner/<?php echo $user['UserProfile']['id']; ?>/0/<?php echo base64_encode($this->here); ?>'>Remove as Possible Winner</a>
		<?php else: ?>
		<a href='/mediahunt_media_items/mark_winner/<?php echo $user['UserProfile']['id']; ?>/1/<?php echo base64_encode($this->here); ?>'>Mark as Possible Winner</a>
		<?php endif; ?>
	</div>
