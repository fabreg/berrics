<div class="unifiedShops index">
 ...
 |
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $unifiedShop['UnifiedShop']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $unifiedShop['UnifiedShop']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $unifiedShop['UnifiedShop']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $unifiedShop['UnifiedShop']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
