<div class='index form'>
	...
	<div style='float:right; width:29%;'>
		<fieldset>
			...
			echo $this->Form->create("MediaViewFilters",array("url"=>$this->here));
			echo $this->Form->input("date_start",array("value"=>$this->params['named']['date_start']));
			echo $this->Form->input("date_end",array("value"=>$this->params['named']['date_end']));
