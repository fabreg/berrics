...
<?php echo $this->Form->create('CanteenOrderNote');?>
	<fieldset>
		<legend><?php __('Edit Canteen Order Note'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('CanteenOrderNote.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('CanteenOrderNote.id'))); ?></li>
