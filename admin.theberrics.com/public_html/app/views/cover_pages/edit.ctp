...
<div class='form' style='width:800px; margin:auto;'>
	<fieldset>
		...
		<?php 
			...
			echo $this->Form->create("CoverPage",array("url"=>$this->here));
			
			echo "<div style='font-size:120%; font-weight:bold;'>Category :";
			if($this->data['AberricaCategory']['id']>0) {
				
				echo $this->data['AberricaCategory']['name'];
		...
		<?php 
			...
			if(isset($this->data['MediaFile']['id'])) {
		...
		?>
			<div class='attach-link' style='padding:10px;'>
				<?php echo $this->Admin->attachMediaLink("CoverPage","id",$this->data['CoverPage']['id'],$this->here); ?>
			</div>
		<?php
