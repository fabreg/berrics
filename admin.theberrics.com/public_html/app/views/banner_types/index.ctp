<div class="bannerTypes index">
	<h2><?php __('Banner Types');?></h2>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $bannerType['BannerType']['id']; ?>&nbsp;</td>
		<td><?php echo $bannerType['BannerType']['created']; ?>&nbsp;</td>
		<td><?php echo $bannerType['BannerType']['modified']; ?>&nbsp;</td>
		<td><?php echo $bannerType['BannerType']['width']; ?>&nbsp;</td>
		<td><?php echo $bannerType['BannerType']['height']; ?>&nbsp;</td>
		<td><?php echo $bannerType['BannerType']['name']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $bannerType['BannerType']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $bannerType['BannerType']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $bannerType['BannerType']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $bannerType['BannerType']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
