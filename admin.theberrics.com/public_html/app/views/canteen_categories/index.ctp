...
<div class='index'>
	...
	<table cellspacing='0'>
		...
		<tr>
			...
			<td class='actions'>
							<?php echo $this->Html->link("Edit",array("action"=>"edit",$v['CanteenCategory']['id'])); ?> 
							<?php 
								if($v['CanteenCategory']['parent_id']<=0) {
							...
							<?php echo $this->Html->link("Move Down",array("action"=>"move_down",$v['CanteenCategory']['id'],1)); ?> 
							<?php echo $this->Html->link("Remove",array("action"=>"remove",$v['CanteenCategory']['id']),array("onclick"=>"return confirm('Are you sure you wanna do this?')")); ?> 
