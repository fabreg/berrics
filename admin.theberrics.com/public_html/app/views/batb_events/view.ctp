			...
			?>
				...
				<tr>
					...
					<td width='20%' style='text-align:center;' class='players-cell'>
						...
						<div>
							<?php echo $this->Html->link("(Flip Positions)",array("controller"=>"batb_events","action"=>"flip_positions",$match['BatbMatch']['id'])); ?>
						</div>
						<?php endif; ?>
					</td>
					...
					<td class='' align='center' valign='middle' width='10%'>
						<?php echo $this->Html->link("Update Video Links",array("controller"=>"batb_events","action"=>"update_videos",$match['BatbMatch']['id'])); ?><br />
						<?php echo $this->Html->link("Update Match Stats",array("controller"=>"batb_events","action"=>"update_match_stats",$match['BatbMatch']['id'])); ?>
						<?php 
						
							if(!in_array($match['BatbMatch']['id'],$featured_matches)) {
								echo "<br />";
								echo "<br />";
								echo $this->Html->link("Mark as Saturday",array("controller"=>"batb_events","action"=>"mark_as_featured",$match['BatbMatch']['id'],1));
								echo "<br />";
								echo $this->Html->link("Mark as Sunday",array("controller"=>"batb_events","action"=>"mark_as_featured",$match['BatbMatch']['id'],2));
								echo "<br />";
							...
							if(!in_array($match['BatbMatch']['id'],$featured_stats)) {
								...
								echo "<br />";
								echo $this->Html->link("Mark as Featured Stats 1",array("controller"=>"batb_events","action"=>"mark_as_featured_stats",$match['BatbMatch']['id'],1));
								echo "<br />";
								echo $this->Html->link("Mark as Featured Stats 2",array("controller"=>"batb_events","action"=>"mark_as_featured_stats",$match['BatbMatch']['id'],2));
